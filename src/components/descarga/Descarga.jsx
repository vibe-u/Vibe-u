...
const Descarga = () => {
    return (
        ...
        <div className="container">
            ...
            <a href="URL_TU_APP_STORE" target="_blank" rel="noopener noreferrer" className="btn btn-appstore">
                <img src={appStoreImg} alt="Descargar en App Store" />
                <span></span>
            </a>
            <a href="URL_TU_GOOGLE_PLAY" target="_blank" rel="noopener noreferrer" className="btn btn-googleplay">
